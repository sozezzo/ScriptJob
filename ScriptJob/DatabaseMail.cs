...
";
        ...
        public string Create(SqlCommand sqlCommand)
        {
            return Db.ExecuteGetColumnToString(sqlCommand, _sqlCreate, 1);
        }


        public string Drop(SqlCommand sqlCommand)
        {
            return Db.ExecuteGetColumnToString(sqlCommand, _sqlDrop, 1);
        }
